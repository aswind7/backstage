import{r as R,j as e}from"./iframe-CVxNCVyG.js";import{c as C}from"./clsx-B-dksMZM.js";import{u as H}from"./useStyles-DTicY05F.js";import{T as i}from"./Text-Be9dnUXP.js";import"./preload-helper-D9Z9MdNV.js";const g={"bui-Card":"_bui-Card_1t20q_20","bui-CardBody":"_bui-CardBody_1t20q_34","bui-CardHeader":"_bui-CardHeader_1t20q_41","bui-CardFooter":"_bui-CardFooter_1t20q_45"},c=R.forwardRef((o,s)=>{const{classNames:t,cleanedProps:a}=H("Card",o),{className:d,...n}=a;return e.jsx("div",{ref:s,className:C(t.root,g[t.root],d),...n})}),h=R.forwardRef((o,s)=>{const{classNames:t,cleanedProps:a}=H("Card",o),{className:d,...n}=a;return e.jsx("div",{ref:s,className:C(t.header,g[t.header],d),...n})}),p=R.forwardRef((o,s)=>{const{classNames:t,cleanedProps:a}=H("Card",o),{className:d,...n}=a;return e.jsx("div",{ref:s,className:C(t.body,g[t.body],d),...n})}),w=R.forwardRef((o,s)=>{const{classNames:t,cleanedProps:a}=H("Card",o),{className:d,...n}=a;return e.jsx("div",{ref:s,className:C(t.footer,g[t.footer],d),...n})});c.__docgenInfo={description:`Card component.
